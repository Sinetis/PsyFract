#ifndef _ETFRACTAL_H_
#define _ETFRACTAL_H_
...
class ETfractal: public IFractal
{
...
float2 com[5];
	...
	for (int i = 0; i < 4; i++)
	{
		com[i].x = (comn[i].x - mid) / max;
		com[i].y = (comn[i].y - mid) / max;
	}
